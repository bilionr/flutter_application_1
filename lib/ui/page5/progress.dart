...
class ProgressDetailsView extends StatefulWidget {
  const ProgressDetailsView({super.key});

  @override
  State<ProgressDetailsView> createState() => _ProgressDetailsView();
}

class _ProgressDetailsView extends State<ProgressDetailsView> {
  List workArr = [
