...
class WorkoutDetailView3 extends StatefulWidget {
  const WorkoutDetailView3({super.key});

  @override
  State<WorkoutDetailView3> createState() => _WorkoutDetailView3State();
}

class _WorkoutDetailView3State extends State<WorkoutDetailView3> {
  List workArr = [
