...
class WorkoutDetailView4 extends StatefulWidget {
  const WorkoutDetailView4({super.key});

  @override
  State<WorkoutDetailView4> createState() => _WorkoutDetailView4State();
}

class _WorkoutDetailView4State extends State<WorkoutDetailView4> {
  List workArr = [
