...
class WorkoutDetailView2 extends StatefulWidget {
  const WorkoutDetailView2({super.key});

  @override
  State<WorkoutDetailView2> createState() => _WorkoutDetailView2State();
}

class _WorkoutDetailView2State extends State<WorkoutDetailView2> {
  List workArr = [
